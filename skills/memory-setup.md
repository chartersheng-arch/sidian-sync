---
uid: skill-memory-setup
name: memory-setup
created: 2026-04-12
tags: [skill, openclaw]
description: "Enable and configure Moltbot/Clawdbot memory search for persistent context. Use when setting up memory, fixing goldfish brain, or helping users configure memorySearch in their config. Covers MEMORY.md"
path: /mnt/e/AIopen/openclaws/skills/memory-setup/
---
