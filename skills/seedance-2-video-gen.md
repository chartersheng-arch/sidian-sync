---
uid: skill-seedance-2-video-gen
name: seedance-2-video-gen
created: 2026-04-12
tags: [skill, openclaw]
description: "Seedance 2.0 AI video generation via EvoLink API. Three modes — text-to-video, image-to-video (1-2 images), reference-to-video (images + videos + audio). Auto audio (voice, SFX, BGM). Works with Ope"
path: /mnt/e/AIopen/openclaws/skills/seedance-2-video-gen/
---
