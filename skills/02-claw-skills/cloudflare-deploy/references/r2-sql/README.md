...
2. [configuration.md](skills/02-claw-skills/cloudflare-deploy/references/r2-sql/configuration.md) - Enable catalog, create tokens
3. [patterns.md](skills/02-claw-skills/cloudflare-deploy/references/r2-sql/patterns.md) - Wrangler CLI and integration examples
4. [api.md](skills/02-claw-skills/cloudflare-deploy/references/r2-sql/api.md) - SQL syntax and query reference
5. [gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/r2-sql/gotchas.md) - Limitations and troubleshooting

**Quick reference?** Jump to:
- [Run a query via Wrangler](skills/02-claw-skills/cloudflare-deploy/references/r2-sql/patterns.md#wrangler-cli-query)
- [SQL syntax reference](skills/02-claw-skills/cloudflare-deploy/references/r2-sql/api.md#sql-syntax)
- [ORDER BY limitations](skills/02-claw-skills/cloudflare-deploy/references/r2-sql/gotchas.md#order-by-limitations)
...
- See [gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/r2-sql/gotchas.md) for complete limitations

## In This Reference

- **[configuration.md](skills/02-claw-skills/cloudflare-deploy/references/r2-sql/configuration.md)** - Enable catalog, create API tokens
- **[api.md](skills/02-claw-skills/cloudflare-deploy/references/r2-sql/api.md)** - SQL syntax, functions, operators, data types
- **[patterns.md](skills/02-claw-skills/cloudflare-deploy/references/r2-sql/patterns.md)** - Wrangler CLI, HTTP API, Pipelines, PyIceberg
- **[gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/r2-sql/gotchas.md)** - Limitations, troubleshooting, performance tips
