...
See [pipelines/patterns.md](skills/02-claw-skills/cloudflare-deploy/references/pipelines/patterns.md) for detailed setup.
...
See [r2-data-catalog/patterns.md](skills/02-claw-skills/cloudflare-deploy/references/r2-data-catalog/patterns.md) for advanced PyIceberg patterns.
...
See [r2-data-catalog/patterns.md](skills/02-claw-skills/cloudflare-deploy/references/r2-data-catalog/patterns.md) for more engines.
...
- [api.md](skills/02-claw-skills/cloudflare-deploy/references/r2-sql/api.md) - SQL syntax reference
- [gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/r2-sql/gotchas.md) - Limitations and troubleshooting
- [r2-data-catalog/patterns.md](skills/02-claw-skills/cloudflare-deploy/references/r2-data-catalog/patterns.md) - PyIceberg advanced patterns
- [pipelines/patterns.md](skills/02-claw-skills/cloudflare-deploy/references/pipelines/patterns.md) - Streaming ingestion patterns
