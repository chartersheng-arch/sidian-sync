...
| **Type mismatch on binding** | Wrong interface type | See [api.md](skills/02-claw-skills/cloudflare-deploy/references/pages-functions/api.md) bindings table for correct types |
...
**See also:** [configuration.md](skills/02-claw-skills/cloudflare-deploy/references/pages-functions/configuration.md) for TypeScript setup | [patterns.md](skills/02-claw-skills/cloudflare-deploy/references/pages-functions/patterns.md) for middleware/auth | [api.md](skills/02-claw-skills/cloudflare-deploy/references/pages-functions/api.md) for bindings
