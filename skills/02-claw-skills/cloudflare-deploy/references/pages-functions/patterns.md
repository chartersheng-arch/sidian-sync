...
**See also:** [api.md](skills/02-claw-skills/cloudflare-deploy/references/pages-functions/api.md) for `env.ASSETS.fetch()` | [gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/pages-functions/gotchas.md) for debugging
