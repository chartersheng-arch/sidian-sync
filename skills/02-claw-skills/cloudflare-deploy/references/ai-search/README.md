...
- **[api.md](skills/02-claw-skills/cloudflare-deploy/references/ai-search/api.md)** - API endpoints, methods, TypeScript interfaces
- **[configuration.md](skills/02-claw-skills/cloudflare-deploy/references/ai-search/configuration.md)** - Setup, data sources, wrangler config
- **[patterns.md](skills/02-claw-skills/cloudflare-deploy/references/ai-search/patterns.md)** - Common patterns, decision guidance, code examples
- **[gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/ai-search/gotchas.md)** - Troubleshooting, code-level gotchas, limits
