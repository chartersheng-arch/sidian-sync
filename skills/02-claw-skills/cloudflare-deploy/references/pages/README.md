...
2. [configuration.md](skills/02-claw-skills/cloudflare-deploy/references/pages/configuration.md) - Project setup, wrangler.jsonc, bindings
3. [api.md](skills/02-claw-skills/cloudflare-deploy/references/pages/api.md) - Functions API, routing, context
4. [patterns.md](skills/02-claw-skills/cloudflare-deploy/references/pages/patterns.md) - Common implementations
5. [gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/pages/gotchas.md) - Troubleshooting & pitfalls

**Quick reference?** Jump to relevant file above.

## In This Reference

- [configuration.md](skills/02-claw-skills/cloudflare-deploy/references/pages/configuration.md) - wrangler.jsonc, build, env vars, Smart Placement
- [api.md](skills/02-claw-skills/cloudflare-deploy/references/pages/api.md) - Functions API, bindings, context, advanced mode
- [patterns.md](skills/02-claw-skills/cloudflare-deploy/references/pages/patterns.md) - Full-stack patterns, framework integration
- [gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/pages/gotchas.md) - Build issues, limits, debugging, framework warnings
