...
1. **[configuration.md](skills/02-claw-skills/cloudflare-deploy/references/web-analytics/configuration.md)** - Setup for proxied vs non-proxied sites
2. **[integration.md](integration.md)** - Framework-specific beacon integration (React, Next.js, Vue, Nuxt, etc.)
3. **[patterns.md](skills/02-claw-skills/cloudflare-deploy/references/web-analytics/patterns.md)** - Common use cases (performance monitoring, GDPR consent, multi-site tracking)
4. **[gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/web-analytics/gotchas.md)** - Troubleshooting (SPA tracking, CSP issues, hash routing limitations)
