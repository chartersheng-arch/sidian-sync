...
|-------------------|------------|
| Create/deploy Worker quickly | Essential Commands below → [patterns.md](skills/02-claw-skills/cloudflare-deploy/references/wrangler/patterns.md) §New Worker |
| Configure bindings (KV, D1, R2) | [configuration.md](skills/02-claw-skills/cloudflare-deploy/references/wrangler/configuration.md) §Bindings |
| Write integration tests | [api.md](skills/02-claw-skills/cloudflare-deploy/references/wrangler/api.md) §startWorker |
| Debug production issues | [gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/wrangler/gotchas.md) + Essential Commands §Monitoring |
| Set up multi-environment workflow | [configuration.md](skills/02-claw-skills/cloudflare-deploy/references/wrangler/configuration.md) §Environments |
...
- [configuration.md](skills/02-claw-skills/cloudflare-deploy/references/wrangler/configuration.md) - wrangler.jsonc setup, environments, bindings
- [api.md](skills/02-claw-skills/cloudflare-deploy/references/wrangler/api.md) - Programmatic API (`startWorker`, `getPlatformProxy`, events)
- [patterns.md](skills/02-claw-skills/cloudflare-deploy/references/wrangler/patterns.md) - Common workflows and development patterns
- [gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/wrangler/gotchas.md) - Common pitfalls, limits, and troubleshooting
