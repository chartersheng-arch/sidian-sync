...
2. [patterns.md](skills/02-claw-skills/cloudflare-deploy/references/workerd/patterns.md) - Common workflows, framework examples

**When you need details:**
3. [configuration.md](skills/02-claw-skills/cloudflare-deploy/references/workerd/configuration.md) - Config format, services, bindings
4. [api.md](skills/02-claw-skills/cloudflare-deploy/references/workerd/api.md) - Runtime APIs, TypeScript types
5. [gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/workerd/gotchas.md) - Common errors, debugging
