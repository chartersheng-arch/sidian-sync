...
|-----------|------------|-----------|
| Enable Argo for first time | Quick Start above → [configuration.md](skills/02-claw-skills/cloudflare-deploy/references/argo-smart-routing/configuration.md) | [gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/argo-smart-routing/gotchas.md) |
| Use TypeScript/Python SDK | [api.md](skills/02-claw-skills/cloudflare-deploy/references/argo-smart-routing/api.md) | [patterns.md](skills/02-claw-skills/cloudflare-deploy/references/argo-smart-routing/patterns.md) |
| Terraform/IaC setup | [configuration.md](skills/02-claw-skills/cloudflare-deploy/references/argo-smart-routing/configuration.md) | - |
| Enable for Spectrum TCP app | [patterns.md](skills/02-claw-skills/cloudflare-deploy/references/argo-smart-routing/patterns.md) → Spectrum section | [api.md](skills/02-claw-skills/cloudflare-deploy/references/argo-smart-routing/api.md) |
| Troubleshoot enablement issue | [gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/argo-smart-routing/gotchas.md) | [api.md](skills/02-claw-skills/cloudflare-deploy/references/argo-smart-routing/api.md) |
| Manage billing/usage | [patterns.md](skills/02-claw-skills/cloudflare-deploy/references/argo-smart-routing/patterns.md) → Billing section | [gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/argo-smart-routing/gotchas.md) |

## In This Reference

- **[api.md](skills/02-claw-skills/cloudflare-deploy/references/argo-smart-routing/api.md)** - API endpoints, SDK methods, error handling, Python/TypeScript examples
- **[configuration.md](skills/02-claw-skills/cloudflare-deploy/references/argo-smart-routing/configuration.md)** - Terraform setup, environment config, billing configuration
- **[patterns.md](skills/02-claw-skills/cloudflare-deploy/references/argo-smart-routing/patterns.md)** - Tiered Cache integration, Spectrum TCP apps, billing management, validation patterns
- **[gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/argo-smart-routing/gotchas.md)** - Common errors, permission issues, limits, best practices
