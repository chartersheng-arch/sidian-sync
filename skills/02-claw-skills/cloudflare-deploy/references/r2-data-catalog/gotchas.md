...
**Solution:** Check file count, compact if >1000 or avg <10MB. See [api.md](skills/02-claw-skills/cloudflare-deploy/references/r2-data-catalog/api.md#compaction).
...
**Solution:** Add retry with exponential backoff (see [patterns.md](skills/02-claw-skills/cloudflare-deploy/references/r2-data-catalog/patterns.md#pattern-6-concurrent-writes-with-retry)).
...
- [patterns.md](skills/02-claw-skills/cloudflare-deploy/references/r2-data-catalog/patterns.md) - Working examples
- [api.md](skills/02-claw-skills/cloudflare-deploy/references/r2-data-catalog/api.md) - API reference
