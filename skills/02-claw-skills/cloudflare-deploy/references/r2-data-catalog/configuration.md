...
See [patterns.md](skills/02-claw-skills/cloudflare-deploy/references/r2-data-catalog/patterns.md) for integration examples with other query engines.
...
See [gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/r2-data-catalog/gotchas.md) for detailed troubleshooting.
