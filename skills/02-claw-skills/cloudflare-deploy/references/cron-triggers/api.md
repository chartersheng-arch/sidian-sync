...
**Production security:** The `/__scheduled` endpoint is available in production and can be triggered by anyone. Block it or implement authentication - see [gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/cron-triggers/gotchas.md#security-concerns)
...
- [README.md](skills/02-claw-skills/cloudflare-deploy/references/cron-triggers/README.md) - Overview
- [patterns.md](skills/02-claw-skills/cloudflare-deploy/references/cron-triggers/patterns.md) - Use cases, examples
- [gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/cron-triggers/gotchas.md) - Common errors, testing issues
