...
| Enable Cache Reserve for your zone | README.md + [configuration.md](skills/02-claw-skills/cloudflare-deploy/references/cache-reserve/configuration.md) |
| Use with Workers (understand limitations) | [api.md](skills/02-claw-skills/cloudflare-deploy/references/cache-reserve/api.md) |
| Setup via SDKs or IaC (TypeScript, Python, Terraform) | [configuration.md](skills/02-claw-skills/cloudflare-deploy/references/cache-reserve/configuration.md) |
| Optimize costs and debug issues | [patterns.md](skills/02-claw-skills/cloudflare-deploy/references/cache-reserve/patterns.md) + [gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/cache-reserve/gotchas.md) |
| Understand eligibility and troubleshoot | [gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/cache-reserve/gotchas.md) → [patterns.md](skills/02-claw-skills/cloudflare-deploy/references/cache-reserve/patterns.md) |

**Files:**
- [configuration.md](skills/02-claw-skills/cloudflare-deploy/references/cache-reserve/configuration.md) - Setup, API, SDKs, and Cache Rules
- [api.md](skills/02-claw-skills/cloudflare-deploy/references/cache-reserve/api.md) - Purging, monitoring, Workers integration
- [patterns.md](skills/02-claw-skills/cloudflare-deploy/references/cache-reserve/patterns.md) - Best practices, cost optimization, debugging
- [gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/cache-reserve/gotchas.md) - Common issues, limitations, troubleshooting
