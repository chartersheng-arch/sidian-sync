...
|-------|------|------|--------------|
| 1 | [configuration.md](skills/02-claw-skills/cloudflare-deploy/references/pulumi/configuration.md) | Resource config for Workers/KV/D1/R2/Queues/Pages | First time setup, resource reference |
| 2 | [patterns.md](skills/02-claw-skills/cloudflare-deploy/references/pulumi/patterns.md) | Architecture patterns, multi-env, component resources | Building complex apps, best practices |
| 3 | [api.md](skills/02-claw-skills/cloudflare-deploy/references/pulumi/api.md) | Outputs, dependencies, imports, dynamic providers | Advanced features, integrations |
| 4 | [gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/pulumi/gotchas.md) | Common errors, troubleshooting, limits | Debugging, deployment issues |

## In This Reference
- [configuration.md](skills/02-claw-skills/cloudflare-deploy/references/pulumi/configuration.md) - Provider config, stack setup, Workers/bindings
- [api.md](skills/02-claw-skills/cloudflare-deploy/references/pulumi/api.md) - Resource types, Workers script, KV/D1/R2/queues/Pages
- [patterns.md](skills/02-claw-skills/cloudflare-deploy/references/pulumi/patterns.md) - Multi-env, secrets, CI/CD, stack management
- [gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/pulumi/gotchas.md) - State issues, deployment failures, limits
