...
Deploy HTML/CSS/images with Workers. See [api.md](skills/02-claw-skills/cloudflare-deploy/references/workers-for-platforms/api.md#static-assets) for upload process.
...
See [api.md](skills/02-claw-skills/cloudflare-deploy/references/workers-for-platforms/api.md) for programmatic deployment via REST API or SDK.
...
Add via API metadata (see [api.md](skills/02-claw-skills/cloudflare-deploy/references/workers-for-platforms/api.md#deploy-with-bindings)):
```json
{
  "bindings": [
...
See [README.md](skills/02-claw-skills/cloudflare-deploy/references/workers-for-platforms/README.md), [api.md](skills/02-claw-skills/cloudflare-deploy/references/workers-for-platforms/api.md), [patterns.md](skills/02-claw-skills/cloudflare-deploy/references/workers-for-platforms/patterns.md), [gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/workers-for-platforms/gotchas.md)
