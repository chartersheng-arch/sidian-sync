...
- See [api.md](skills/02-claw-skills/cloudflare-deploy/references/workers-for-platforms/api.md#static-assets) for full implementation
...
See [README.md](skills/02-claw-skills/cloudflare-deploy/references/workers-for-platforms/README.md), [configuration.md](skills/02-claw-skills/cloudflare-deploy/references/workers-for-platforms/configuration.md), [api.md](skills/02-claw-skills/cloudflare-deploy/references/workers-for-platforms/api.md), [gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/workers-for-platforms/gotchas.md)
