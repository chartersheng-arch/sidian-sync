...
**Critical:** v5 renamed many resources (`cloudflare_record` → `cloudflare_dns_record`, `cloudflare_worker_*` → `cloudflare_workers_*`). See [gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/terraform/gotchas.md#v5-breaking-changes) for migration details.
...
1. Start with [README.md](skills/02-claw-skills/cloudflare-deploy/references/terraform/README.md) for provider setup and authentication
2. Review [configuration.md](skills/02-claw-skills/cloudflare-deploy/references/terraform/configuration.md) for resource configurations
3. Check [api.md](skills/02-claw-skills/cloudflare-deploy/references/terraform/api.md) for data sources and existing resource queries
4. See [patterns.md](skills/02-claw-skills/cloudflare-deploy/references/terraform/patterns.md) for multi-environment and CI/CD patterns
5. Read [gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/terraform/gotchas.md) for state drift, v5 breaking changes, and troubleshooting

## In This Reference
- [configuration.md](skills/02-claw-skills/cloudflare-deploy/references/terraform/configuration.md) - Resources for zones, DNS, workers, KV, R2, D1, Pages, rulesets
- [api.md](skills/02-claw-skills/cloudflare-deploy/references/terraform/api.md) - Data sources for existing resources
- [patterns.md](skills/02-claw-skills/cloudflare-deploy/references/terraform/patterns.md) - Architecture patterns, multi-env setup, CI/CD integration
- [gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/terraform/gotchas.md) - Common issues, security, best practices
