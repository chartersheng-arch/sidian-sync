...
- [configuration.md](skills/02-claw-skills/cloudflare-deploy/references/workers-ai/configuration.md) - wrangler.jsonc setup, TypeScript types, bindings, environment variables
- [api.md](skills/02-claw-skills/cloudflare-deploy/references/workers-ai/api.md) - env.AI.run(), streaming, function calling, REST API, response types
- [patterns.md](skills/02-claw-skills/cloudflare-deploy/references/workers-ai/patterns.md) - RAG with Vectorize, prompt engineering, batching, error handling, caching
- [gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/workers-ai/gotchas.md) - Deprecated @cloudflare/ai package, rate limits, pricing, common errors
