...
1. **[configuration.md](skills/02-claw-skills/cloudflare-deploy/references/workers-playground/configuration.md)** - Start here: playground setup, constraints, deployment
2. **[api.md](skills/02-claw-skills/cloudflare-deploy/references/workers-playground/api.md)** - Core APIs: Request, Response, ExecutionContext, fetch, Cache
3. **[patterns.md](skills/02-claw-skills/cloudflare-deploy/references/workers-playground/patterns.md)** - Common use cases: routing, proxying, A/B testing, multi-module code
4. **[gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/workers-playground/gotchas.md)** - Troubleshooting: errors, browser issues, limits, best practices

## In This Reference

- **[configuration.md](skills/02-claw-skills/cloudflare-deploy/references/workers-playground/configuration.md)** - Setup, deployment, configuration
- **[api.md](skills/02-claw-skills/cloudflare-deploy/references/workers-playground/api.md)** - API endpoints, methods, interfaces
- **[patterns.md](skills/02-claw-skills/cloudflare-deploy/references/workers-playground/patterns.md)** - Common patterns, use cases, examples
- **[gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/workers-playground/gotchas.md)** - Troubleshooting, best practices, limitations
