...
Email submission (port 587). **WARNING**: See [gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/spectrum/gotchas.md#smtp-reverse-dns)
...
- [configuration.md](skills/02-claw-skills/cloudflare-deploy/references/spectrum/configuration.md) - Origin type setup
- [gotchas.md](skills/02-claw-skills/cloudflare-deploy/references/spectrum/gotchas.md) - Protocol limitations
- [api.md](skills/02-claw-skills/cloudflare-deploy/references/spectrum/api.md) - SDK reference
