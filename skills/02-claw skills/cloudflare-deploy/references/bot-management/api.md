...
See [patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/bot-management/patterns.md) for Workers examples: mobile app allowlisting, corporate proxy exemption, datacenter detection, conditional delay, and more.
