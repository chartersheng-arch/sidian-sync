...
3. [patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/miniflare/patterns.md) - Testing patterns (getPlatformProxy, Vitest, node:test)
4. [configuration.md](skills/02-claw%20skills/cloudflare-deploy/references/miniflare/configuration.md) - Configure bindings, storage, multiple workers

**Troubleshooting:**
- [gotchas.md](skills/02-claw%20skills/cloudflare-deploy/references/miniflare/gotchas.md) - Common errors and debugging

**API reference:**
- [api.md](skills/02-claw%20skills/cloudflare-deploy/references/miniflare/api.md) - Complete method reference
