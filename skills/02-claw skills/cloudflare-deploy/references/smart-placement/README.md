...
2. [configuration.md](skills/02-claw%20skills/cloudflare-deploy/references/smart-placement/configuration.md) - set up wrangler.jsonc and understand limitations
3. [patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/smart-placement/patterns.md) - see practical examples for your use case
4. [api.md](skills/02-claw%20skills/cloudflare-deploy/references/smart-placement/api.md) - monitor and verify Smart Placement is working
5. [gotchas.md](skills/02-claw%20skills/cloudflare-deploy/references/smart-placement/gotchas.md) - troubleshoot common issues

**Quick lookup:**
- "Should I enable Smart Placement?" → See "When to Use" above
- "How do I configure it?" → [configuration.md](skills/02-claw%20skills/cloudflare-deploy/references/smart-placement/configuration.md)
- "How do I split frontend/backend?" → [patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/smart-placement/patterns.md)
- "Why isn't it working?" → [gotchas.md](skills/02-claw%20skills/cloudflare-deploy/references/smart-placement/gotchas.md)

## In This Reference

- [configuration.md](skills/02-claw%20skills/cloudflare-deploy/references/smart-placement/configuration.md) - wrangler.jsonc setup, mode values, validation rules
- [api.md](skills/02-claw%20skills/cloudflare-deploy/references/smart-placement/api.md) - Placement Status API, cf-placement header, monitoring
- [patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/smart-placement/patterns.md) - Frontend/backend split, database workers, SSR patterns
- [gotchas.md](skills/02-claw%20skills/cloudflare-deploy/references/smart-placement/gotchas.md) - Troubleshooting INSUFFICIENT_INVOCATIONS, performance issues
