...
For deprecated frameworks, see [gotchas.md](skills/02-claw%20skills/cloudflare-deploy/references/pages/gotchas.md#framework-specific) for migration options.
