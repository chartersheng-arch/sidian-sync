...
**Limitations:** Cannot order by non-partition columns. See [gotchas.md](skills/02-claw%20skills/cloudflare-deploy/references/r2-sql/gotchas.md#order-by-limitations)
...
- [patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/r2-sql/patterns.md) - Query examples and use cases
- [gotchas.md](skills/02-claw%20skills/cloudflare-deploy/references/r2-sql/gotchas.md) - SQL limitations and error handling
- [configuration.md](skills/02-claw%20skills/cloudflare-deploy/references/r2-sql/configuration.md) - Setup and authentication
