...
**Note:** HTTP API endpoint URL may vary - see [patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/r2-sql/patterns.md#http-api-query) for current endpoint.
...
- [r2-data-catalog/configuration.md](skills/02-claw%20skills/cloudflare-deploy/references/r2-data-catalog/configuration.md) - Detailed token setup and PyIceberg connection
- [patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/r2-sql/patterns.md) - Query examples using configuration
- [gotchas.md](skills/02-claw%20skills/cloudflare-deploy/references/r2-sql/gotchas.md) - Common configuration errors
