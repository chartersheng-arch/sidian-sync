...
- **[configuration.md](skills/02-claw%20skills/cloudflare-deploy/references/static-assets/configuration.md)** - Setup, deployment, configuration
- **[api.md](skills/02-claw%20skills/cloudflare-deploy/references/static-assets/api.md)** - API endpoints, methods, interfaces
- **[patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/static-assets/patterns.md)** - Common patterns, use cases, examples
- **[gotchas.md](skills/02-claw%20skills/cloudflare-deploy/references/static-assets/gotchas.md)** - Troubleshooting, best practices, limitations
