...
2. [configuration.md](skills/02-claw%20skills/cloudflare-deploy/references/r2-data-catalog/configuration.md) - Enable catalog, create tokens
3. [patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/r2-data-catalog/patterns.md) - PyIceberg setup and common patterns
4. [api.md](skills/02-claw%20skills/cloudflare-deploy/references/r2-data-catalog/api.md) - REST API reference as needed
5. [gotchas.md](skills/02-claw%20skills/cloudflare-deploy/references/r2-data-catalog/gotchas.md) - Troubleshooting when issues arise

**Quick reference?** Jump to:
- [Enable catalog on bucket](skills/02-claw%20skills/cloudflare-deploy/references/r2-data-catalog/configuration.md#enable-catalog-on-bucket)
- [PyIceberg connection pattern](skills/02-claw%20skills/cloudflare-deploy/references/r2-data-catalog/patterns.md#pyiceberg-connection-pattern)
- [Permission errors](skills/02-claw%20skills/cloudflare-deploy/references/r2-data-catalog/gotchas.md#permission-errors)
...
- **[configuration.md](skills/02-claw%20skills/cloudflare-deploy/references/r2-data-catalog/configuration.md)** - Enable catalog, create API tokens, connect clients
- **[api.md](skills/02-claw%20skills/cloudflare-deploy/references/r2-data-catalog/api.md)** - REST endpoints, operations, maintenance
- **[patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/r2-data-catalog/patterns.md)** - PyIceberg examples, common use cases
- **[gotchas.md](skills/02-claw%20skills/cloudflare-deploy/references/r2-data-catalog/gotchas.md)** - Troubleshooting, best practices, limitations
