...
1. **[configuration.md](skills/02-claw%20skills/cloudflare-deploy/references/tail-workers/configuration.md)** - Set up Tail Workers
2. **[api.md](skills/02-claw%20skills/cloudflare-deploy/references/tail-workers/api.md)** - Handler signature, types, redaction
3. **[patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/tail-workers/patterns.md)** - Common use cases and integrations
4. **[gotchas.md](skills/02-claw%20skills/cloudflare-deploy/references/tail-workers/gotchas.md)** - Pitfalls and debugging tips
