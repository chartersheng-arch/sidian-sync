...
|-------|------|---------|-------------|
| 1 | [configuration.md](skills/02-claw%20skills/cloudflare-deploy/references/stream/configuration.md) | Setup SDKs, env vars, signing keys | Starting new project |
| 2 | [api.md](skills/02-claw%20skills/cloudflare-deploy/references/stream/api.md) | On-demand video APIs | Implementing uploads/playback |
| 3 | [api-live.md](api-live.md) | Live streaming APIs | Building live streaming |
| 4 | [patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/stream/patterns.md) | Full-stack flows, TUS, JWT signing | Implementing workflows |
| 5 | [gotchas.md](skills/02-claw%20skills/cloudflare-deploy/references/stream/gotchas.md) | Errors, limits, troubleshooting | Debugging issues |

## In This Reference

- [configuration.md](skills/02-claw%20skills/cloudflare-deploy/references/stream/configuration.md) - Setup, environment variables, wrangler config
- [api.md](skills/02-claw%20skills/cloudflare-deploy/references/stream/api.md) - On-demand video upload, playback, management APIs
- [api-live.md](api-live.md) - Live streaming (RTMPS/SRT/WebRTC), simulcast
- [patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/stream/patterns.md) - Full-stack flows, state management, best practices
- [gotchas.md](skills/02-claw%20skills/cloudflare-deploy/references/stream/gotchas.md) - Error codes, troubleshooting, limits
