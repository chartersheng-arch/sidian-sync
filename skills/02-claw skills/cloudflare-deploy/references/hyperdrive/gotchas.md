...
See [README.md](skills/02-claw%20skills/cloudflare-deploy/references/hyperdrive/README.md), [configuration.md](skills/02-claw%20skills/cloudflare-deploy/references/hyperdrive/configuration.md), [api.md](skills/02-claw%20skills/cloudflare-deploy/references/hyperdrive/api.md), [patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/hyperdrive/patterns.md).
...
**Solution:** Enable Smart Placement (`"placement": {"mode": "smart"}` in wrangler.jsonc) to execute Worker near DB. See [patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/hyperdrive/patterns.md) Multi-Query pattern.
