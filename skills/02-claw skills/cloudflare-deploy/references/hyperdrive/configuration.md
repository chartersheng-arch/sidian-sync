...
See [README.md](skills/02-claw%20skills/cloudflare-deploy/references/hyperdrive/README.md) for overview.
...
**Benefits:** Multi-query Workers run closer to DB, reducing round-trip latency. See [patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/hyperdrive/patterns.md) for examples.
...
See [api.md](skills/02-claw%20skills/cloudflare-deploy/references/hyperdrive/api.md), [patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/hyperdrive/patterns.md), [gotchas.md](skills/02-claw%20skills/cloudflare-deploy/references/hyperdrive/gotchas.md).
