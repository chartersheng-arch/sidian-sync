...
1. **New to Email Routing?** → [configuration.md](skills/02-claw%20skills/cloudflare-deploy/references/email-routing/configuration.md) → [patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/email-routing/patterns.md)
2. **Adding Workers?** → [api.md](skills/02-claw%20skills/cloudflare-deploy/references/email-routing/api.md) § Worker Runtime API → [patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/email-routing/patterns.md)
3. **Sending emails?** → [api.md](skills/02-claw%20skills/cloudflare-deploy/references/email-routing/api.md) § SendEmail Binding
4. **Managing via API?** → [api.md](skills/02-claw%20skills/cloudflare-deploy/references/email-routing/api.md) § REST API Operations
5. **Debugging issues?** → [gotchas.md](skills/02-claw%20skills/cloudflare-deploy/references/email-routing/gotchas.md)
...
- **[configuration.md](skills/02-claw%20skills/cloudflare-deploy/references/email-routing/configuration.md)** - Setup, deployment, wrangler config
- **[api.md](skills/02-claw%20skills/cloudflare-deploy/references/email-routing/api.md)** - REST API + Worker runtime API + types
- **[patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/email-routing/patterns.md)** - Common patterns with working examples
- **[gotchas.md](skills/02-claw%20skills/cloudflare-deploy/references/email-routing/gotchas.md)** - Critical pitfalls, troubleshooting, limits
