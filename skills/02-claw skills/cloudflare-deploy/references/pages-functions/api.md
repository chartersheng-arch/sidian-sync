...
**TypeScript:** See [configuration.md](skills/02-claw%20skills/cloudflare-deploy/references/pages-functions/configuration.md) for `wrangler types` setup
...
See [configuration.md](skills/02-claw%20skills/cloudflare-deploy/references/pages-functions/configuration.md) for wrangler.jsonc examples.
...
**See also:** [configuration.md](skills/02-claw%20skills/cloudflare-deploy/references/pages-functions/configuration.md) for TypeScript setup and wrangler.jsonc | [patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/pages-functions/patterns.md) for middleware and auth patterns
