...
- [Configuration](skills/02-claw%20skills/cloudflare-deploy/references/workers/configuration.md) - wrangler.jsonc setup, bindings, environments
- [API](skills/02-claw%20skills/cloudflare-deploy/references/workers/api.md) - Runtime APIs, bindings, execution context
- [Patterns](skills/02-claw%20skills/cloudflare-deploy/references/workers/patterns.md) - Common workflows, testing, optimization
- [Frameworks](frameworks.md) - Hono, routing, validation
- [Gotchas](skills/02-claw%20skills/cloudflare-deploy/references/workers/gotchas.md) - Common issues, limits, troubleshooting
...
- [KV](skills/02-claw%20skills/cloudflare-deploy/references/kv/README.md) - Key-value storage
- [D1](skills/02-claw%20skills/cloudflare-deploy/references/d1/README.md) - SQL database
- [R2](skills/02-claw%20skills/cloudflare-deploy/references/r2/README.md) - Object storage
- [Durable Objects](skills/02-claw%20skills/cloudflare-deploy/references/durable-objects/README.md) - Stateful coordination
- [Queues](skills/02-claw%20skills/cloudflare-deploy/references/queues/README.md) - Message queues
