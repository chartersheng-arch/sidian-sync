...
See [patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/workerd/patterns.md) for usage examples, [configuration.md](skills/02-claw%20skills/cloudflare-deploy/references/workerd/configuration.md) for config details.
