...
See [patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/workerd/patterns.md) for multi-service examples, [gotchas.md](skills/02-claw%20skills/cloudflare-deploy/references/workerd/gotchas.md) for config errors.
