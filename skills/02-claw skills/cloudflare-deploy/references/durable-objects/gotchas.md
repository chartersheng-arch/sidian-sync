...
**Solution:** Shard across multiple DOs (see [Patterns: Sharding](skills/02-claw%20skills/cloudflare-deploy/references/durable-objects/patterns.md))
...
- **[Patterns](skills/02-claw%20skills/cloudflare-deploy/references/durable-objects/patterns.md)** - Workarounds for common limitations
- **[API](skills/02-claw%20skills/cloudflare-deploy/references/durable-objects/api.md)** - Storage limits and quotas
- **[Configuration](skills/02-claw%20skills/cloudflare-deploy/references/durable-objects/configuration.md)** - Setting CPU limits
