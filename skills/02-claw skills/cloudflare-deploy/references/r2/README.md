...
- [configuration.md](skills/02-claw%20skills/cloudflare-deploy/references/r2/configuration.md) - Bindings, S3 SDK, CORS, lifecycles, token scopes
- [api.md](skills/02-claw%20skills/cloudflare-deploy/references/r2/api.md) - Workers API, multipart, conditional requests, presigned URLs
- [patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/r2/patterns.md) - Streaming, caching, client uploads, public buckets
- [gotchas.md](skills/02-claw%20skills/cloudflare-deploy/references/r2/gotchas.md) - List truncation, etag format, stream length, S3 SDK region
