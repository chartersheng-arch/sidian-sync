...
## Reading Order
1. **[configuration.md](skills/02-claw%20skills/cloudflare-deploy/references/snippets/configuration.md)** - Start here: setup, deployment methods (Dashboard/API/Terraform)
2. **[api.md](skills/02-claw%20skills/cloudflare-deploy/references/snippets/api.md)** - Core APIs: Request, Response, headers, `request.cf` properties
3. **[patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/snippets/patterns.md)** - Real-world examples: geo-routing, A/B tests, security headers
4. **[gotchas.md](skills/02-claw%20skills/cloudflare-deploy/references/snippets/gotchas.md)** - Troubleshooting: common errors, performance tips, API limitations

## In This Reference

- **[configuration.md](skills/02-claw%20skills/cloudflare-deploy/references/snippets/configuration.md)** - Setup, deployment, configuration
- **[api.md](skills/02-claw%20skills/cloudflare-deploy/references/snippets/api.md)** - API endpoints, methods, interfaces
- **[patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/snippets/patterns.md)** - Common patterns, use cases, examples
- **[gotchas.md](skills/02-claw%20skills/cloudflare-deploy/references/snippets/gotchas.md)** - Troubleshooting, best practices, limitations
