...
|------|---------|--------------|
| [api.md](skills/02-claw%20skills/cloudflare-deploy/references/zaraz/api.md) | Web API, zaraz object, consent methods | Implementing tracking calls |
| [configuration.md](skills/02-claw%20skills/cloudflare-deploy/references/zaraz/configuration.md) | Dashboard setup, triggers, tools | Initial setup, adding tools |
| [patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/zaraz/patterns.md) | SPA, e-commerce, Worker integration | Best practices, common scenarios |
| [gotchas.md](skills/02-claw%20skills/cloudflare-deploy/references/zaraz/gotchas.md) | Troubleshooting, limits, pitfalls | Debugging issues |
