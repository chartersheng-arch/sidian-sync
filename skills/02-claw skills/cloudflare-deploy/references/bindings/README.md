...
2. **[api.md](skills/02-claw%20skills/cloudflare-deploy/references/bindings/api.md)** - TypeScript types and env access patterns
3. **[configuration.md](skills/02-claw%20skills/cloudflare-deploy/references/bindings/configuration.md)** - Complete wrangler.jsonc examples
4. **[patterns.md](skills/02-claw%20skills/cloudflare-deploy/references/bindings/patterns.md)** - Best practices and common patterns
5. **[gotchas.md](skills/02-claw%20skills/cloudflare-deploy/references/bindings/gotchas.md)** - Critical pitfalls and troubleshooting
...
Bindings are fully typed via `wrangler types`. See [api.md](skills/02-claw%20skills/cloudflare-deploy/references/bindings/api.md) for details.

## Limits

- 64 bindings max per Worker (all types combined)
- See [gotchas.md](skills/02-claw%20skills/cloudflare-deploy/references/bindings/gotchas.md) for per-binding limits
