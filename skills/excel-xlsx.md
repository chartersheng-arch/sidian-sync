---
uid: skill-excel-xlsx
name: Excel / XLSX
created: 2026-04-12
tags: [skill, openclaw]
description: "Create, inspect, and edit Microsoft Excel workbooks and XLSX files with reliable formulas, dates, types, formatting, recalculation, and template preservation. Use when (1) the task is about Excel, `.x"
path: /mnt/e/AIopen/openclaws/skills/excel-xlsx/
---
